          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4 relative">
              <HeaderSmall
                text="What Do I Do?"
              />
              <h1 className="sm:w-4/5 mb-3 mt-1 text-4xl sm:text-5xl md:text-7xl lg:text-lg font-normal tracking-wide text-white leading-normal lg:leading-7">
                I create elegant, logical web and mobile app solutions. In my
                hobby time, I design or play F1.
              </h1>
